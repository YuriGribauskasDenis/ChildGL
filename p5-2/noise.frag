...
uniform sampler2D texUnit20;
uniform sampler2D texUnit21;
uniform sampler2D texUnit22;
uniform sampler2D texUnit23;
uniform sampler2D texUnit24;
...
void main() { 
    ...
    vec4 unit20 = texture(texUnit20, texCoordFrag);
    vec4 unit21 = texture(texUnit21, texCoordFrag);
    vec4 unit22 = texture(texUnit22, texCoordFrag);
    vec4 unit23 = texture(texUnit23, texCoordFrag);
    vec4 unit24 = texture(texUnit24, texCoordFrag);
